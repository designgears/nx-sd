...
class StatusMonitorOverlayComponent(NXSDComponent):
    ...
    def install(self, install_directory):
        ...
        component_dict = {
            'overlay': (
                Path(self._source_directory, 'Status-Monitor-Overlay.ovl'),
                Path(dest_overlays, 'Status-Monitor-Overlay.ovl'),
            ),
        }
...
def get_component():
    return StatusMonitorOverlayComponent()
