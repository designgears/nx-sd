...
COMPONENT_COMMIT_OR_TAG = 'c6ed6e0'
DOCKER_IMAGE_NAME = COMPONENT_NAME.lower()+'-builder'


class TeslaMenuComponent(NXSDComponent):
    ...
    def install(self, install_directory):
        ...
        component_dict = {
            'overlays': (
                Path(self._source_directory, 'ovlmenu.ovl'),
                Path(dest_overlays, 'ovlmenu.ovl'),
            ),
        }
